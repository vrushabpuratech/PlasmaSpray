...
<div class="innerheading">
    ...
    <div class="row">
    <div class="col-sm-2"><img src="{{ asset('website/img/plasma_trans_arc_small.jpg') }}" class="img-responsive center-block"></div>
    ...
    <div class="innerimgbox"><img src="{{ asset('website/img/plasma_trans_arc.jpg') }}" class="img-responsive"></div>    
    </div>        
    </div>
    </div>    
    </div>
