...
<div class="innerheading">
    ...
    <div class="row">
    <div class="col-sm-3"><img src="{{ asset('dist/img/hvofs_small.jpg') }}" alt="HVOF" class="img-responsive center-block"></div>
    ...
    <div class="innerimgbox"><img src="{{ asset('dist/img/hvofs.jpg') }}" alt="HVOFS" class="img-responsive"></div>    
    </div>        
    </div>
    </div>    
    </div>
